package com.aractron.java.resourceboundle.fromclass;
...
public class App{
    public static void main(String[] args){
		 ...
		 */
		ResourceBundle resourceBundle = ResourceBundle.getBundle("com.aractron.java.resourceboundle.fromclass.Labels", new Locale("en"));
		...
		resourceBundle = ResourceBundle.getBundle("com.aractron.java.resourceboundle.fromclass.Labels", new Locale("it"));
